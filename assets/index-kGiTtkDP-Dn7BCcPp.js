import{Ao as e,Dc as t,Du as n,Hs as r,Il as i,Ou as a,Qs as o,Tc as s,ac as c,fo as l,ho as u,ic as d,pl as f,qs as p,tc as m}from"./index-D0_oRExe.js";var h=l`
  :host {
    position: relative;
...
`,g=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},_=class extends s{constructor(){super(...arguments),this.disabled=!1,this.value=``}render(){return c`<input
      type="number"
      maxlength="1"
      inputmode="numeric"
      autofocus
      ...
      value=${this.value}
    /> `}};_.styles=[m,e,h],g([f({type:Boolean})],_.prototype,`disabled`,void 0),g([f({type:String})],_.prototype,`value`,void 0),_=g([i(`wui-input-numeric`)],_);var v=a`
  :host {
    position: relative;
    display: block;
  }
...
`,S=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},C,w=C=class extends s{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){super(),this.loading=!1,this.timeoutTimeLeft=n.getTimeToNextEmailLogin(),this.error=``,this.otp=``,this.email=o.state.data?.email,this.authConnector=p.getAuthConnector()}render(){if(!this.email)throw Error(`w3m-email-otp-widget: No email provided`);let e=!!this.timeoutTimeLeft,t=this.getFooterLabels(e);return c`
      <wui-flex
    ...
    `}startOTPTimeout(){this.timeoutTimeLeft=n.getTimeToNextEmailLogin(),this.OTPTimeout=setInterval(()=>{this.timeoutTimeLeft>0?this.timeoutTimeLeft=n.getTimeToNextEmailLogin():clearInterval(this.OTPTimeout)},1e3)}async onOtpInputChange(e){try{this.loading||(this.otp=e.detail,this.shouldSubmitOnOtpChange()&&(this.loading=!0,await this.onOtpSubmit?.call(this,this.otp)))}catch(e){this.error=r.parseError(e),this.loading=!1}}async onResendCode(){try{if(this.onOtpResend){if(!this.loading&&!this.timeoutTimeLeft){if(this.error=``,this.otp=``,!p.getAuthConnector()||!this.email)throw Error(`w3m-email-otp-widget: Unable to resend email`);this.loading=!0,await this.onOtpResend(this.email),this.startOTPTimeout(),t.showSuccess(`Code email resent`)}}else this.onStartOver&&this.onStartOver()}catch(e){t.showError(e)}finally{this.loading=!1}}getFooterLabels(e){return this.onStartOver?{title:`Something wrong?`,action:`Try again ${e?`in ${this.timeoutTimeLeft}s`:``}`}:{title:`Didn't receive it?`,action:`Resend ${e?`in ${this.timeoutTimeLeft}s`:`Code`}`}}shouldSubmitOnOtpChange(){return this.authConnector&&this.otp.length===C.OTP_LENGTH}};w.OTP_LENGTH=6,w.styles=x,S([u()],w.prototype,`loading`,void 0),S([u()],w.prototype,`timeoutTimeLeft`,void 0),S([u()],w.prototype,`error`,void 0),w=C=S([i(`w3m-email-otp-widget`)],w);export{w as t};