import{F as e,Fn as t,Fr as n,Mn as r,Nt as i,Oi as a,Rn as o,Rr as s,Rt as c,Ti as l,Tn as ee,Un as u,Wn as d,Xn as f,ar as p,c as te,cr as m,di as ne,ei as h,et as g,gi as _,h as v,ht as re,ia as y,pa as ie,pi as b,pn as ae,qi as x,tt as oe,zt as S}from"./index-TcHyavTm.js";import{a as C}from"./index-CA8dbl9V-BdHshTYP.js";import{t as se}from"./SwapController-ZhAftJtk-ChLzIPY1.js";var w={isUnsupportedChainView(){return o.state.view===`UnsupportedChain`||o.state.view===`SwitchNetwork`&&o.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){a.shake();return}if(await s.isSIWXCloseDisabled()){a.shake();return}(o.state.view===`DataCapture`||o.state.view===`DataCaptureOtpConfirm`)&&ne.disconnect(),a.close()}},ce=f`
  :host {
    display: block;
