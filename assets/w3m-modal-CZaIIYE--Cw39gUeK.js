import{D as e,Gn as t,Hn as n,Jt as r,Kn as i,Li as a,Nt as o,Oi as s,Or as c,Pn as l,Vi as u,X as d,Zr as f,_n as p,dr as m,ei as h,et as g,gi as ee,ia as _,ir as v,l as te,lr as y,m as b,ma as ne,mt as re,ta as x,vt as S,yi as C,zn as w,zt as ie}from"./index-BbGo_s0e.js";import{a as T}from"./index-Dq5sz2DL-CbMU2X38.js";import{t as ae}from"./SwapController-DFlWWUd5-BAJ48fMG.js";var E={isUnsupportedChainView(){return w.state.view===`UnsupportedChain`||w.state.view===`SwitchNetwork`&&w.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){s.shake();return}if(await a.isSIWXCloseDisabled()){s.shake();return}(w.state.view===`DataCapture`||w.state.view===`DataCaptureOtpConfirm`)&&ee.disconnect(),s.close()}},oe=d`
  :host {
    display: block;
