import{$n as e,Bn as t,Di as n,Ji as r,Kt as i,O as a,On as o,Tr as s,Un as c,Ut as l,Yn as u,_i as d,ar as f,g as p,ma as m,mr as h,st as g,v as _}from"./index-LPU4__CM.js";import"./index-Ce-b2IvQ-BDe7UCOw.js";import{t as v}from"./SwapController-DEiC1k9k-CtuNp4gX.js";var y={numericInputKeyDown(e,t,n){let r=[`Backspace`,`Meta`,`Ctrl`,`a`,`A`,`c`,`C`,`x`,`X`,`v`,`V`,`ArrowLeft`,`ArrowRight`,`Tab`],i=e.metaKey||e.ctrlKey,a=e.key,o=a.toLocaleLowerCase(),s=o===`a`,c=o===`c`,l=o===`v`,u=o===`x`,d=a===`,`,f=a===`.`,p=a>=`0`&&a<=`9`;!i&&(s||c||l||u)&&e.preventDefault(),t===`0`&&!d&&!f&&a===`0`&&e.preventDefault(),t===`0`&&p&&(n(a),e.preventDefault()),(d||f)&&(t||(n(`0.`),e.preventDefault()),(t!=null&&t.includes(`.`)||t!=null&&t.includes(`,`))&&e.preventDefault()),!p&&!r.includes(a)&&!f&&!d&&e.preventDefault()}},b=e`
  :host {
    width: 100%;
  }
...
`,T=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},E=class extends h{constructor(){super(...arguments),this.target=`sourceToken`}render(){return u`
    ...
    `}};E.styles=[w],T([l()],E.prototype,`target`,void 0),E=T([d(`w3m-swap-input-skeleton`)],E);var D=e`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`,O=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},k=5e-5,A=class extends h{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target=`sourceToken`,this.onSetAmount=null,this.onSetMaxValue=null}render(){let e=this.marketValue||`0`,t=i.bigNumber(e).gt(`0`);return u`
    ...
    </button>`}onFocusChange(e){this.focused=e}onSelectToken(){r.sendEvent({type:`track`,event:`CLICK_SELECT_TOKEN_TO_SWAP`}),c.push(`SwapSelectToken`,{target:this.target})}onBuyToken(){c.push(`OnRampProviders`)}};A.styles=[D],O([l()],A.prototype,`focused`,void 0),O([l()],A.prototype,`balance`,void 0),O([l()],A.prototype,`value`,void 0),O([l()],A.prototype,`price`,void 0),O([l()],A.prototype,`marketValue`,void 0),O([l()],A.prototype,`disabled`,void 0),O([l()],A.prototype,`target`,void 0),O([l()],A.prototype,`token`,void 0),O([l()],A.prototype,`onSetAmount`,void 0),O([l()],A.prototype,`onSetMaxValue`,void 0),A=O([d(`w3m-swap-input`)],A);var j=e`
...
`,M=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},N=class extends h{subscribe({resetSwapState:e,initializeSwapState:t}){return()=>{_.subscribeKey(`activeCaipNetwork`,n=>this.onCaipNetworkChange({newCaipNetwork:n,resetSwapState:e,initializeSwapState:t})),_.subscribeChainProp(`accountState`,n=>{this.onCaipAddressChange({newCaipAddress:n?.caipAddress,resetSwapState:e,initializeSwapState:t})})}}constructor(){super(),this.unsubscribe=[],this.initialParams=c.state.data?.swap,this.detailsOpen=!1,this.caipAddress=_.getAccountData()?.caipAddress,this.caipNetworkId=_.state.activeCaipNetwork?.caipNetworkId,this.initialized=v.state.initialized,this.loadingQuote=v.state.loadingQuote,this.loadingPrices=v.state.loadingPrices,this.loadingTransaction=v.state.loadingTransaction,this.sourceToken=v.state.sourceToken,this.sourceTokenAmount=v.state.sourceTokenAmount,this.sourceTokenPriceInUSD=v.state.sourceTokenPriceInUSD,this.toToken=v.state.toToken,this.toTokenAmount=v.state.toTokenAmount,this.toTokenPriceInUSD=v.state.toTokenPriceInUSD,this.inputError=v.state.inputError,this.fetchError=v.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document!=null&&document.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{!this.sourceToken||!this.toToken||(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=s.debounce(async()=>{await v.swapTokens()},200),this.subscribe({resetSwapState:!0,initializeSwapState:!1})(),this.unsubscribe.push(this.subscribe({resetSwapState:!1,initializeSwapState:!0}),n.subscribeKey(`open`,e=>{e||v.resetState()}),c.subscribeKey(`view`,e=>{e.includes(`Swap`)||v.resetValues()}),v.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.fetchError=e.fetchError,e.sourceToken&&e.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){v.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval),document==null||document.removeEventListener(`visibilitychange`,this.visibilityChangeHandler)}render(){return u`
    ...
    `}templateTokenInput(e,t){let n=v.state.myTokensWithBalance?.find(e=>e?.address===t?.address),r=e===`toToken`?this.toTokenAmount:this.sourceTokenAmount,a=e===`toToken`?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,o=i.parseLocalStringToNumber(r)*a;return u`<w3m-swap-input
    ...
    </wui-flex>`}async onSwitchTokens(){await v.switchTokens()}async onSwapPreview(){this.fetchError&&await v.swapTokens(),r.sendEvent({type:`track`,event:`INITIATE_SWAP`,properties:{network:this.caipNetworkId||``,swapFromToken:this.sourceToken?.symbol||``,swapToToken:this.toToken?.symbol||``,swapFromAmount:this.sourceTokenAmount||``,swapToAmount:this.toTokenAmount||``,isSmartAccount:f(_.state.activeChain)===a.ACCOUNT_TYPES.SMART_ACCOUNT}}),c.push(`SwapPreview`)}async handleSwapParameters(){this.initialParams&&(v.state.initialized||await new Promise(e=>{let t=v.subscribeKey(`initialized`,n=>{n&&(t?.(),e())})}),await this.setSwapParameters(this.initialParams))}async setSwapParameters({amount:e,fromToken:t,toToken:n}){(!v.state.tokens||!v.state.myTokensWithBalance)&&await new Promise(e=>{let t=v.subscribeKey(`myTokensWithBalance`,n=>{n&&n.length>0&&(t?.(),e())});setTimeout(()=>{t?.(),e()},5e3)});let r=[...v.state.tokens||[],...v.state.myTokensWithBalance||[]];if(t){let e=r.find(e=>e.symbol.toLowerCase()===t.toLowerCase());e&&v.setSourceToken(e)}if(n){let e=r.find(e=>e.symbol.toLowerCase()===n.toLowerCase());e&&v.setToToken(e)}e&&!isNaN(Number(e))&&v.setSourceTokenAmount(e)}onCaipAddressChange({newCaipAddress:e,resetSwapState:t,initializeSwapState:n}){this.caipAddress!==e&&(this.caipAddress=e,t&&v.resetState(),n&&v.initializeState())}onCaipNetworkChange({newCaipNetwork:e,resetSwapState:t,initializeSwapState:n}){this.caipNetworkId!==e?.caipNetworkId&&(this.caipNetworkId=e?.caipNetworkId,t&&v.resetState(),n&&v.initializeState())}};N.styles=j,M([l({type:Object})],N.prototype,`initialParams`,void 0),M([g()],N.prototype,`interval`,void 0),M([g()],N.prototype,`detailsOpen`,void 0),M([g()],N.prototype,`caipAddress`,void 0),M([g()],N.prototype,`caipNetworkId`,void 0),M([g()],N.prototype,`initialized`,void 0),M([g()],N.prototype,`loadingQuote`,void 0),M([g()],N.prototype,`loadingPrices`,void 0),M([g()],N.prototype,`loadingTransaction`,void 0),M([g()],N.prototype,`sourceToken`,void 0),M([g()],N.prototype,`sourceTokenAmount`,void 0),M([g()],N.prototype,`sourceTokenPriceInUSD`,void 0),M([g()],N.prototype,`toToken`,void 0),M([g()],N.prototype,`toTokenAmount`,void 0),M([g()],N.prototype,`toTokenPriceInUSD`,void 0),M([g()],N.prototype,`inputError`,void 0),M([g()],N.prototype,`fetchError`,void 0),M([g()],N.prototype,`lastTokenPriceUpdate`,void 0),N=M([d(`w3m-swap-view`)],N);var P=e`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`,R=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},z=class extends h{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){if(!this.visible)return null;let e=this.amount&&this.price?i.multiply(this.price,this.amount)?.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};z.styles=[t,p,L],R([l()],z.prototype,`imageSrc`,void 0),R([l()],z.prototype,`name`,void 0),R([l()],z.prototype,`symbol`,void 0),R([l()],z.prototype,`price`,void 0),R([l()],z.prototype,`amount`,void 0),R([g()],z.prototype,`visible`,void 0),R([g()],z.prototype,`imageError`,void 0),z=R([d(`wui-token-list-item`)],z);var B=e`
  :host {
    width: 100%;
  }
...
`,V=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},H=class extends h{render(){return u`
    ...
    `}};H.styles=[t,B],H=V([d(`wui-token-list-item-loader`)],H);var U=e`
  :host {
