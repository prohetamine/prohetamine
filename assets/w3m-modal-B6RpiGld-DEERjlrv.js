import{$ as e,B as t,Bn as n,Dn as r,Gt as i,Hn as a,K as o,Kn as s,Li as c,Mi as l,N as ee,Qi as u,Zn as d,_r as f,an as p,at as m,bi as h,fa as g,g as te,hr as _,ia as v,in as y,lr as b,mi as x,ut as S,v as C,vn as w,w as ne,xt as T,zi as E}from"./index-CT9srxrf.js";import{a as D}from"./index-DSpGrqDD-oOlm5Wmz.js";import{t as re}from"./SwapController-Cy3OZ3F4-wtwq-NML.js";var O={isUnsupportedChainView(){return s.state.view===`UnsupportedChain`||s.state.view===`SwitchNetwork`&&s.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await l.isSIWXCloseDisabled()){g.shake();return}(s.state.view===`DataCapture`||s.state.view===`DataCaptureOtpConfirm`)&&c.disconnect(),g.close()}},ie=m`
  :host {
    display: block;
